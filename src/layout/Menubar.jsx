...
const Menubar = () => {
  return (
    <div className="main-container hidden lg:block bg-white shadow sticky top-0">
      <ul className="flex gap-5 sticky">
        <li className="group py-3">
          CPU / Processor
          <ul className="hidden absolute top-10 bg-white border border-gray-300 rounded shadow group-hover:block border-t-4 border-t-secondary">
